    ...
    registerAbilities: function() {
        ...
        this.registerAbility({
            ...
            effect: function(character) {
                // Apply stat boosts
                for (const [stat, value] of Object.entries(this.statBoosts)) {
                    character.addBuff(stat, value, this.duration);
                }
        ...
        this.registerAbility({
            ...
            animation: 'idle',
            effect: function(character) {
                character.addEffect('damageReduction', this.damageReduction, this.duration);
                return true;
            }
        });
